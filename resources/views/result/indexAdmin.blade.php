        ...
        @foreach ($results as $result)
            <div class="row">
                ...
                @endif
                    ...
                    <div class="col-3">
                        <a href="{{ route('result.edit',[$result]) }}" class="btn btn-primary" style="margin-bottom: 5px">Editar Jornada</a>
                        <a href="{{ route('result.editResult',[$result]) }}" class="btn btn-primary" style="margin-bottom: 5px">Editar Resultado</a>
